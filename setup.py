...
if __name__ == "__main__":
    ...
    setup(
        ...
        data_files=[
            (
                _data_install_dir(),
                list(ifilter(path.isfile, imap(_data_join, listdir(_data_join())))),
            ),
            (
                _data_cache_install_dir(),
                list(map(_data_cache_join, listdir(_data_cache_join()))),
            ),
        ],
    )
