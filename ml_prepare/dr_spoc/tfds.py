...
def dr_spoc_builder(dataset_name, data_dir, dr_spoc_init,
    ...
    :param dr_spoc_init:
    :type dr_spoc_init: ``bool``

    :param dr_spoc_parent_dir:
    :type dr_spoc_parent_dir: ``str``
    ...
    if dr_spoc_init:
        from ml_prepare.dr_spoc.utils import get_data
    ...
    def builder_factory(resolution, rgb, data_dir):
        ...
        :param rgb: True if red|green|blue else grayscale
        :type rgb: ``bool``

        :return:
        :rtype: tfds.image.ImageLabelFolder
        """
